...
#             # Submit button (outside columns but inside form)
#             submitted = st.form_submit_button("Predict Diabetes Status")
...
#         # Example: show some plots (you can add plot_1 and plot_2 back if you want)
#         col3, col4 = st.columns(2)
#         with col3:
#             st.pyplot(plot_3_bmi_distribution(df))
#         with col4:
...
if not df.empty and model is not None:
    ...
    with tab1:
        ...
        # ✅ Raw data sample removed as requested
